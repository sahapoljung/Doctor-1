...
public class AnalysisChooseFragment extends Fragment implements View.OnClickListener {
    ...
    private void pad(TextView textView) {
        ...
        textView.setText("คุณมีอาการแทรกซ้อน ควรไปพบแพทย์โดยด่วน");
    }
    ...
    private void main1() {
        ...
        Spinner spinner = getView().findViewById(R.id.spnchoose);
        spinner.setMinimumWidth(50);
        ...
        if (in.equals("01000")) {pad(textView);}
        ...
        if (in.equals("001000")) { pad(textView);}
