...
public class AnalysisActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Log.d("26JanV1", "in at Anlysis ไรไร" + in);
        ...
        if (in.equals("0")) {textView.setText("คุณมีอาการคัดจมูก แน่นจมูก หรือมีน้ำมูกไหล ใช่หรือไม่");}
    ...
    private void main1() {
      ...
      // button3.setOnClickListener(this);
        ...
        if (in.equals("0000000")) {textView.setText("แอพพลิเคชั่นไม่สามารถวิเคราะห์ได้ ควรปรึกษาแพทย์");SetTxt();}
    ...
    private void sick1(TextView textView ) {
        ...
        char someChar = '1';
        int count = 0;
        Log.d("26JanV1", "in at Anlysis six" + six);
            ...
            ||in.equals("1111110")||in.equals("1101110")||in.equals("1110110")||in.equals("1100110")||in.equals("1111010")||in.equals("1101010")||in.equals("1110010")||in.equals("1100010")
                ...
                Log.d("26JanV1", "in at Anlysis count" + count);
    ...
    private void SetTxt() {
        Button button1 = findViewById(R.id.btnYes);
        Button button2 = findViewById(R.id.btnNo);
        TextView textView1 = findViewById(R.id.next);
    ...
    private void sick4(TextView textView ){
        ...
        if (in.equals("11")||in.equals("10")) { textView.setText("โรคขาดวิตามินบี 1 หรือโรคเหน็บชา");
            SetTxt();
            for (int i = 0; i < in.length(); i++) {
                if (in.charAt(i) == someChar) {
                    count++;
